...
from net.internet.common.nets.layer import make_linear_layers,make_conv_layers,make_deconv_layers
from net.internet.common.nets.resnet import ResNetBackbone
...
class PoseNet(nn.Layer):
    def __init__(self, joint_num):
        ...
        self.joint_conv_2 = make_conv_layers([256, self.joint_num * cfg.output_hm_shape[0]], kernel=1, stride=1,
                                             padding=0, bnrelu_final=False)
        # self.joint_conv_3= make_conv_layers([])
