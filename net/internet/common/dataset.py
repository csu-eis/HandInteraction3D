...
class InterhandsDataset(Dataset):
    ...
    def __init__(self,transform,mode='train'):
        ...
        # if self.mode
        if self.mode == 'val':
            self.rootnet_output_path = cfg.dataset_root_path+'/Interhand2.6M/rootnet_output/rootnet_interhand2.6m_output_val.json'
        else:
            self.rootnet_output_path =cfg.dataset_root_path+ '/Interhand2.6M/rootnet_output/rootnet_interhand2.6m_output_test.json'
